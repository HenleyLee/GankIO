...
import com.henley.gankio.widget.RecycleViewDivider;
...
public class AboutUsActivity extends BaseActivity implements OnItemClickListener {
    ...
    private List<Object> getAboutItems() {
        ...
        items.add(new Developer("HenleyLee", "前端开发者", "https://avatars3.githubusercontent.com/u/11828300?s=100&v=4", "https://github.com/HenleyLee"));
